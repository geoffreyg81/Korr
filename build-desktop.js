...
writeWindowsFile(path.join(APP_DIR, "0 - À LIRE AVANT DE COMMENCER.txt"), [
  ...
  "1. DÉMARRER KORR",
  "",
  "  Double-cliquez sur « 1 - START KORR - DÉMARRER KORR ».",
  ...
  "",
  "  Korr détecte automatiquement le français et l'anglais.",
  "  Grammalecte corrige le français et Harper corrige l'anglais,",
  "  entièrement sur votre ordinateur. Aucun réglage de langue n'est requis.",
  "  Les menus et notifications suivent la langue d'affichage de Windows.",
  "",
  ...
  "",
  "  Double-cliquez sur « 2 - START WITH WINDOWS - LANCER AVEC WINDOWS ».",
...
writeWindowsFile(path.join(APP_DIR, "0 - READ BEFORE STARTING.txt"), [
  ...
  "",
  "  Korr automatically detects French and English.",
  "  Grammalecte corrects French and Harper corrects English, entirely on",
  "  your computer. You do not need to choose a language first.",
  "  Menus and notifications follow the Windows display language.",
  "",
